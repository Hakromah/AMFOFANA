                ...
                <div className="container mx-auto max-w-[1920px] px-5 md:px-[clamp(20px,5vw,60px)]">
                    <div className="bg-[#2857AE] text-white rounded-3xl p-[clamp(24px,4vw,48px)] relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-[clamp(15px,3vw,35px)]">
                        ...
                        <div className="relative z-10 shrink-0">
                            <Button className="h-fit py-[clamp(10px,3vw,15px)] cursor-pointer px-[clamp(20px,3vw,40px)] rounded-full bg-white text-primary hover:bg-gray-100 font-bold text-sm md:text-lg transition-all duration-300 flex items-center gap-3 group">
                               <a href="/file/sample.pdf" download rel="noopener noreferrer"  className='flex gap-1 items-center'>
