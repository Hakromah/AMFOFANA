                    ...
                    <div className="about-image relative h-full w-full">
                        <div className="flex max-md:flex-col items-center justify-center h-full w-full relative gap-5">
                            <div className="about-school-img md:w-[285px] md:mt-[-180px] md:h-[387px] max-md:aspect-video relative w-full">
                                <Image src="/home/about.png" alt="Classmates" fill className="object-cover relative! w-full! h-full!" />
                            </div>
                            ...
                            <div className="about-school-img md:w-[285px] md:h-[387px] max-md:aspect-video max-md:hidden relative w-full max-md:h-full">
                                <Image src="/home/about2.png" alt="Classmates" fill className="object-cover relative! w-full! h-full!" />
                            </div>
                        </div>
                    ...
                    <div className="w-full h-full">
                        <div className="about-content w-full lg:max-w-[700px] flex flex-col gap-6 max-md:gap-5 max-xs:gap-3">
                            ...
                            <p className="text-[#4B5563] text-[clamp(16px,2vw,20px)] font-normal leading-relaxed max-md:leading-normal">
                                Our school is a place of learning, growth, and character development. We are committed to providing a balanced education that nurtures academic excellence, moral values, and personal responsibility—preparing students for success in both education and life.
                            </p>
                            <div className="bg-[linear-gradient(90deg,_rgba(229,231,235,0.50)_0%,_rgba(248,250,255,0.50)_100%)] gap-6 py-4 max-md:py-2">
                                <div className="flex max-sm:flex-col py-5 max-md:py-2 px-4 gap-5">
                                    <div className="text-primary text-[clamp(16px,2vw,20px)] font-normal text-5 relative before:absolute sm:before:w-[1px] sm:before:h-full before:w-full before:h-[1px] max-sm:before:bottom-[-6px] before:bg-black/10 sm:before:right-[-1px] sm:pr-2">49 Years of Educational Excellence</div>
                                        ...
                                        <a href="" className="block w-fit h-fit">
                                            <div className="group flex gap-2 items-center text-[#021A4A] text-[clamp(16px,2vw,18px)] font-normal md:hover:text-primary transition-all duration-500 whitespace-nowrap">About Our School
                                                <span className="transition-all duration-500">
                                                    <svg className="md:group-hover/about:fill-primary fill-[#021A4A] md:group-hover/about:rotate-[45deg] transition-all duration-500" xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 13 13" fill="none">
