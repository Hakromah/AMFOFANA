          ...
          <div className="container mx-auto w-full h-full max-w-[1308px] py-[clamp(25px,3vw,50px)] px-[clamp(20px,3vw,100px)] bg-primary/10 lg:rounded-[clamp(10px,2vw,20px)]">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-[clamp(20px,3vw,30px)] text-center">
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900">{stats?.students || "1,500+"}</h3>
              ...
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900">{stats?.years || "40+"}</h3>
              ...
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900">{stats?.programs || "15+"}</h3>
                <p className="text-gray-600 font-medium">Programs</p>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-16 h-16 bg-[#2857AE] rounded-lg flex items-center justify-center mb-4 text-white shadow-md">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8"><path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 0 1 3 3h-15a3 3 0 0 1 3-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0V5.625a1.125 1.125 0 0 0-1.125-1.125h-2.25a1.125 1.125 0 0 0-1.125 1.125v9.75" /></svg>
                </div>
                <h3 className="text-2xl font-bold text-gray-900">{stats?.awards || "20+"}</h3>
