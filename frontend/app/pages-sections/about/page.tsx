          ...
          <div className="container mx-auto w-full h-full max-w-[1308px] py-[clamp(25px,3vw,50px)] px-[clamp(20px,3vw,100px)] bg-primary/10 lg:rounded-[clamp(10px,2vw,20px)]">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-[clamp(20px,3vw,30px)] text-center">
              ...
              <div className="flex flex-col items-center">
                ...
                <AnimatedCounter to={1500} suffix="+" duration={2} className="text-2xl font-bold text-gray-900" />
              ...
              <div className="flex flex-col items-center">
                ...
                <AnimatedCounter to={40} suffix="+" duration={2.5} className="text-2xl font-bold text-gray-900" />
              ...
              <div className="flex flex-col items-center">
                ...
                <AnimatedCounter to={15} suffix="+" duration={3} className="text-2xl font-bold text-gray-900" />
              ...
              <div className="flex flex-col items-center">
                ...
                <AnimatedCounter to={20} suffix="+" duration={2.5} className="text-2xl font-bold text-gray-900" />
