...
const customIcon = L.divIcon({
    ...
    html: `   <a href="https://maps.google.com/?q=6.280628622957243,-10.766005500256005" target="_blank" class="text group/marker h-full w-full block duration-500 justify-center">
...
export default function Map() {
    ...
    // Coordinates for A.M. Fofana High School, Monrovia, Liberia
    const position: [number, number] = [6.280628622957243, -10.766005500256005];
