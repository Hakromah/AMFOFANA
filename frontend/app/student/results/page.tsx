      ...
      return (
         <div className="flex h-[80vh] items-center justify-center">
            <div className="animate-pulse flex flex-col items-center gap-2">
               ...
               <p className="text-muted-foreground font-medium">Loading your academic profile...</p>
            </div>
         </div>
      );
   }
            ...
            <div className="flex items-center flex-wrap gap-4">
               <div className="flex items-center gap-4 bg-primary/5 p-4 rounded-xl border border-primary/10 md:hover:border-primary duration-300">
                  <div className="text-right">
                     <p className="text-xs uppercase text-muted-foreground font-bold">Overall Average Grade</p>
            ...
            <Card className="lg:col-span-2 shadow-sm border-slate-200/60 py-5">
               <CardHeader className="flex flex-row items-center justify-between">
                  <div className="flex items-center gap-2">
                     ...
                     <CardTitle className="text-base font-semibold">Score trend compared to class average</CardTitle>
                  </div>
               </CardHeader>
               <CardContent className="h-[320px]">
                  <ResponsiveContainer width="100%" height="100%">
                     <LineChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                        ...
                        <Line name="Class Average" type="monotone" dataKey="classAvg" stroke="#cbd5e1" strokeWidth={2} strokeDasharray="6 6" dot={false} />
                     </LineChart>
                  </ResponsiveContainer>
               </CardContent>
            </Card>
               ...
               <Table>
                  <TableHeader className="sticky top-0 z-10 bg-white shadow-[0_1px_0_0_#e2e8f0]">
                     <TableRow className="bg-slate-50/50">
                        <TableHead className="w-[250px] font-bold pl-6">Exam</TableHead>
                        ...
                        <TableHead className="text-right pr-6 font-bold">Result</TableHead>
                     </TableRow>
                  </TableHeader>
                  <TableBody>
