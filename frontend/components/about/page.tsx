...
export default function AboutPage() {
  return (
    <div className="w-full">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h2 className="text-3xl font-bold text-[#2857AE]">Our History</h2>
      ...
      <section className="py-20 bg-[#2857AE]">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-12">
            {/* Image */}
            <div className="w-full md:w-1/3">
              <div className="relative h-[400px] w-full rounded-[20px] overflow-hidden border-4 border-white/20 shadow-2xl">
                <Image
                  src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=1887&auto=format&fit=crop" /* Placeholder matching the vibe, or use the one from staff if known */
            ...
            <div className="w-full md:w-2/3 text-white">
              ...
              <div className="mt-8">
                <h3 className="text-2xl font-bold">Dr. Ibrahim Kamara</h3>
      ...
      {/* Mission & Vision Section */}
      <section id="mission" className="py-20 bg-[#0B1120]">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Mission */}
            <div className="bg-white p-10 rounded-[20px] shadow-sm">
              <div className="w-12 h-12 bg-gradient-to-br from-[#2857AE] to-[#15346F] rounded-lg mb-6 flex items-center justify-center shadow-lg">
      ...
      <section id="values" className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#2857AE]">Our Core Value</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Card 1: Dual Curriculum */}
            <div className="group rounded-[20px] p-8 shadow-lg transition-all duration-300 hover:-translate-y-2 bg-[linear-gradient(180deg,_#FFFFFF_0%,_#E8F1FF_25%,_#6a93e0_100%)] border border-blue-100/50">
